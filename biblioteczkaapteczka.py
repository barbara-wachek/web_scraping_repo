...
# with open(f'biblioteczkaapteczka_{datetime.today().date()}.json', 'w', encoding='utf-8') as f:
#     json.dump(all_results, f, ensure_ascii=False)    

# with pd.ExcelWriter(f"biblioteczkaapteczka_{datetime.today().date()}.xlsx", engine='xlsxwriter', options={'strings_to_urls': False}) as writer:    

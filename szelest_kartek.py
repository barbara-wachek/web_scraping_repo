...
#%%def
def szelest_kartek_web_scraping_sitemap_posts(sitemap):
...
#%%main
articles_links = szelest_kartek_web_scraping_sitemap_posts('https://szelestkartek.pl/wp-sitemap-posts-post-1.xml')

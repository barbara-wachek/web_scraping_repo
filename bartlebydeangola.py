...
def dictionary_of_article(article_link):
    ...
    try:
        title_of_article = soup.find('h3', class_='post-title entry-title').text.strip().replace('\xa0', ' ')
    except:
...
#%% main
articles_links = get_articles_links('https://bartlebydeangola.blogspot.com/sitemap.xml')

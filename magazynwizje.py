...
def get_links_of_sitemap(sitemap_link):
    # sitemap_link = 'https://magazynwizje.pl/post-sitemap.xml'
...
def dictionary_of_article(link):
    ...
    try:
        ...
        content_of_article = soup.find('div', class_='wizje-article-text hyphenate')
...
#%% main
articles_links = get_links_of_sitemap('https://magazynwizje.pl/post-sitemap.xml')
